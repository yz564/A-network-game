...
public class ActionInfoTest {
    ...
    @Test
    public void test_cloaking_action_constructor() {
        CloakingActionInfo infoDetail = new CloakingActionInfo("Pratt");
        ActionInfo info = new ActionInfo("Player 1", "cloaking", infoDetail);
        assertEquals("Pratt", info.getCloakingActionInfo().getTargetTerritoryName());
        assertEquals("Pratt", info.getSrcName());
    }
