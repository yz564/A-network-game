...
public class PlayerInfoTest {
    ...
    @Test
    public void test_patent_progress() {
        PlayerInfo p1 = new PlayerInfo("Player 1", 1, 50, 30);
        assertEquals(0, p1.getPatentProgress());
        p1.addPatentProgress(50);
        assertEquals(50, p1.getPatentProgress());
        p1.setPatentProgress(30);
        assertEquals(30, p1.getPatentProgress());
    }
}
