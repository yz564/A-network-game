...
public class V2MapFactoryTest {
  ...
  public void test_makemap() {
    ...
    String[] names1 = { "Fuqua", "Law", "Gross Hall", "FFRC", "Bryan Center", "LSRC", "Pratt", "Perkins Library",
        "Duke Hospital", "Duke Clinics", "Duke Garden", "Duke Chapel", "Student Housing", "Wilson Gym",
        "Cameron Stadium" };
    int[][] adjacency1 = { { 1, 2, 14 }, { 0, 2, 4, 14 }, { 0, 1, 3, 4, 5 }, { 2, 4, 5, 6 }, { 1, 2, 3, 6, 11, 12, 14 },
            { 2, 3, 6, 8 }, { 3, 4, 5, 7, 8, 9, 11 }, { 6, 9, 10, 11 }, { 5, 6, 9 }, { 6, 7, 8, 10 }, { 7, 9, 11, 12 },
            { 4, 6, 7, 10, 12 }, { 4, 10, 11, 13, 14 }, { 12, 14 }, { 0, 1, 4, 12, 13 } };
    String[] names2 = { "Fuqua", "Law", "Gross Hall", "FFRC", "Bryan Center", "LSRC", "Pratt", "Perkins Library",
        "Duke Hospital", "Duke Clinics", "Duke Garden", "Duke Chapel", "Student Housing", "Wilson Gym",
        "Cameron Stadium", "Wallace Stadium" };
    int[][] adjacency2 = { { 1, 2, 14 }, { 0, 2, 4, 14 }, { 0, 1, 3, 4, 5 }, { 2, 4, 5, 6 }, { 1, 2, 3, 6, 11, 12, 14 },
            { 2, 3, 6, 8 }, { 3, 4, 5, 7, 8, 9, 11 }, { 6, 9, 10, 11 }, { 5, 6, 9 }, { 6, 7, 8, 10 }, { 7, 9, 11, 12 },
