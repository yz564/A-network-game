...
/**
 * Subclass to check if destination territory belong to a different player from the source
 * destination on the current worldmap
 */
public class DesOwnershipRuleChecker extends ActionRuleChecker {
    ...
    /**
     * Checks if the destination territory belong to a different player from the source destination
