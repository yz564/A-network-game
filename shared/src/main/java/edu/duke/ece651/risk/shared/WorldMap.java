...
/**
 * Represents an interface for classes that would represent the world map in a RISK game.
 *
 * <p>The World Map contains a number of territories and the initial grouping of territories for a
