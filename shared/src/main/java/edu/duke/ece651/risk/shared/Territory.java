...
public interface Territory extends java.io.Serializable {
    ...
    /**
     * Sets number of units of troops in the territory. Checks if all number of units are valid
     * before setting.
     *
     ...
     * @return true if setting is successful is valid for all Troops, else return false and leave
     *     all Troops unchanged.
     */
     ...
     *
     * @return a HashMap of Territory, which are reachable neighbors of this Territory mapped to
     *     their names.
     */
    public HashMap<String, Territory> getReachableNeighbors();

    /**
     * Gets the moving cost to a neighbouring territory, which is the sum of size of current
     * territory and the neighboring territory.
     *
