...
public interface Territory extends java.io.Serializable {
   ...
   *
   * @param toAdd is a HashMap with String keys are the Troops to add units and
   *              Integer values are the number of units to add to the Troop.
   */
   ...
   *
   * @param toRemove is a HashMap with String keys are the Troops to remove units
   *                 and Integer values are the number of units to remove from the
   *                 Troop.
   */
   ...
   *
   * @return a HashMap with keys are troop name, and values are number of units in
   *         the troop.
   */
