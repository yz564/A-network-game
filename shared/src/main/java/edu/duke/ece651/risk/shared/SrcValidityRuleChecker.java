...
/**
 * Subclass to check if source territory is valid (i.e. the territory belongs to the current player
 * and there are enough units to perform the action)
 */
public class SrcValidityRuleChecker extends ActionRuleChecker {
    ...
    /**
     * Checks if the source territory is valid to perform the action on the given worldmap: 1.
     * source territory belongs to the player who triggered the action 2. there are enough units in
     * the source territory to perform the action
     *
