...
/**
 * In order to be used in writeObject, this class must implements serializable All members also must
 * be serializable
 */
public class ObjectIO implements java.io.Serializable {
    ...
    /**
     * Orders to place initial units at the beginning of the game. HashMap has String key represents
     * the territory name to palce units. Integer vakue reoresents the number of units to place on
     * the key territory.
     */
