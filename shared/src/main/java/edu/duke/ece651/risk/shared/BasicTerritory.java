...
public class BasicTerritory extends AbstractTerritory {
    ...
    /**
     * Makes initial troops for a new territory. Pass makeTroops() in constructor of basic
     * territory.
     *
    ...
    /**
     * Construct a BasicTerritory object with default Troops made by makeTroops(), taking numUnits
     * as a parameter.
     *
     * @param name is the name to assign to the territory.
