...
public class PlayerInfo implements java.io.Serializable {
    ...
    private Integer patentProgress;
     ...
     *
     * @param id is an integer representing player id based on which it is decided which character
     *     is the player is playing as.
     */
    ...
    public String getResearchDomain() {
        return this.playerCharacter.getResearchDomain();
    }
     ...
     *
     * @return a HashMap of visibility status where key is the territory name and value is the
     *     boolean values if the player can see the territory
     */
    ...
    /**
     * Getter of the patent progress of ths player.
     *
     * @return an Integer (larger than 0 and smaller than 100) that represents the patent progress
     *     of a player.
     */
    public Integer getPatentProgress() {
        return this.patentProgress;
    }

    /**
     * Adds of the patent progress of the player by the given amount.
     *
     * @param amountToAdd an integer that represents the amount to add to the patent progress.
     */
    public void addPatentProgress(Integer amountToAdd) {
        this.patentProgress = this.patentProgress + amountToAdd;
    }

    /**
     * Setter of the patent progress of the player.
     *
     * @param newPatentProgress an Integer that represents the new patent progress to set to the
     *     player.
     */
    public void setPatentProgress(Integer newPatentProgress) {
        this.patentProgress = newPatentProgress;
    }
}
