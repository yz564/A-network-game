...
public interface Troop extends java.io.Serializable {
     ...
     *
     * @return true is adding is successful, else returns false.
     */
     ...
     *
     * @return true is removal is successful, else returns false.
     */
    ...
    /**
     * Get the tech cost needed to upgrade a unit from troop that is 1 level lower to a unit in this
     * troop.
     *
