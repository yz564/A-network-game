...
public class ClientOrderHelper {
                        ...
                        new SrcOwnershipRuleChecker(
                                new TroopExistenceRuleChecker(
                                        new EnoughUnitsRuleChecker(
                                                new DesReachableRuleChecker(null)))));
        this.attackChecker =
                new TerritoryExistenceRuleChecker(
                        new SrcOwnershipRuleChecker(
                                new TroopExistenceRuleChecker(
                                        new EnoughUnitsRuleChecker(
                                                new DesOwnershipRuleChecker(
                                                        new DesAdjacencyRuleChecker(null))))));
    ...
    /**
     * Asks for action orders information from the client player, checks the order,c and issues the
