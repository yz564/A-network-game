...
public class UpgradeTechActionsEvenPlayersController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        currTechLevel.setText(String.valueOf(model.getPlayer().getMap().getPlayerInfo(playerName).getTechLevel()));
    ...
    public void onUpgradeTech(ActionEvent ae) throws Exception {
        ...
        if (source instanceof Button) {
            ...
            if (validate != null) {
                ...
                ActionInfo info = af.createUpgradeTechActionInfo(model.getPlayer().getName(), Integer.parseInt((String) newTechLevel.getValue()));
